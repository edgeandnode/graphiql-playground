...
function validateQuerySource({ query }: ValidateQuerySourceArgs): QueryValidationError | Valid {
...
function validateQueryName({ name, updatedId, queries }: ValidateQueryNameArgs): NameValidationError | Valid {
...
export interface ValidateQueryArgs extends ValidateQueryNameArgs, ValidateQuerySourceArgs {}
export function validateQuery({ query, name, updatedId, queries }: ValidateQueryArgs) {
